-- ===================================================================
-- نظام الفواتير - دعم بيع عدة أصناف في فاتورة واحدة
-- Invoice System - Support Multi-Item Sales
-- ===================================================================
...
-- يمكن إلغاء التعليق عن هذا القسم لإنشاء بيانات تجريبية
/*
-- إدراج فاتورة تجريبية
INSERT INTO invoices (user_id, invoice_number, customer_name, sale_type, discount_percentage)
VALUES (
    auth.uid(),
...
-- الحصول على معرف الفاتورة المُدرجة
-- (يجب استبدال هذا بالمعرف الفعلي)
-- INSERT INTO invoice_items (invoice_id, product_id, product_name, quantity, unit_price, final_unit_price, line_total)
-- VALUES (...);
*/

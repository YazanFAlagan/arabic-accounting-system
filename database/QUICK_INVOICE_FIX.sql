-- ===================================================================
-- إصلاح سريع لنظام الفواتير - Quick Invoice Fix
-- ===================================================================

-- 1. إنشاء جدول الفواتير (إذا لم يكن موجوداً)
...
-- 2. إنشاء جدول عناصر الفواتير (إذا لم يكن موجوداً)
...
-- 3. إنشاء دالة توليد رقم الفاتورة
...
-- 4. إنشاء دالة حساب إجماليات الفاتورة
...
-- 5. إنشاء محفز لتحديث إجماليات الفاتورة

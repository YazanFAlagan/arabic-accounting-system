        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-center">
              ...
              <div className="mr-3">
                <h3 className="text-sm font-medium text-blue-800">نظام مخزون متكامل</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>✅ المشتريات تُحدث المخزون تلقائياً • ✅ يمكن تتبع المخزون الفعلي • ✅ ربط كامل مع نظام المشتريات</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  title="تحديث المخزون من قاعدة البيانات"
                >
                  تحديث المخزون
                </button>
                <button
